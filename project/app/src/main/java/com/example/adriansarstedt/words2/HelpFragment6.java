...
public class HelpFragment6 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.help_frag_6, container, false);

        e1 = (TextView) v.findViewById(R.id.e1f6);
    ...
    public static HelpFragment6 newInstance() {
        return new HelpFragment6();
    }
}